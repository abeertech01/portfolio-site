  ...
  return (
    ...
    >
      ...
      <div className="items-stretch gap-6 md:gap-12 grid grid-cols-1 md:grid-cols-2">
        {/* Left — info side */}
        <div className="flex flex-col gap-6 md:gap-8 bg-black/[0.04] dark:bg-white/4 backdrop-blur-[20px] p-4 md:p-7 border border-black/[0.08] dark:border-white/8 rounded-[16px]">
        ...
        <form
          ...
          className="flex flex-col gap-4 bg-black/[0.04] dark:bg-white/4 backdrop-blur-[20px] p-4 md:p-7 border border-black/[0.08] dark:border-white/8 rounded-[16px]"
        >
